...
Note: To watch your files populate in real time, right click on the canvas and press "Refresh". To STOP nifi, right click a blank space and click stop. Make sure to clear the files queues after you've tested to see if NIFI is running. To do this, right click an empty space and click "Empty all Queues"
